...
class Clipping:
    ...
    def start_selection(self, event):
        """Inicia a seleção da janela de recorte ao clicar."""
    ...
    def update_selection(self, event):
        """Atualiza o tamanho do retângulo enquanto o usuário arrasta o mouse."""
        self.canvas.coords(self.rect_id, self.start_x, self.start_y, event.x, event.y)

    def end_selection(self, event):
        """Finaliza a seleção da janela e armazena os valores corretamente."""
    ...
    def do_clipping(self):
        if hasattr(self, 'window'):
            print(f"Aplicando recorte com janela: {self.window}")
            ...
            print("Nenhuma janela selecionada ainda!")
